...
Read my note on the central limit theorem (“Central Limit Theorem.pdf”) and answer following questions using SAS, R, or Python (Show all the relevant output. You do not need to include the SAS/R code):
